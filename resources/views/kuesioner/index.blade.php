        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-body">
                    ...
                    {{-- <form action="{{ route('datarespondents.store') }}" method="post"> --}}
                    <form action="/respondent" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id ="umur" name= "umur"
                                            ...
                                            placeholder="Umur(thn)" autofocus required>
                                        @error('umur')
                        ...
                        <div class="row g-2">
                                    ...
                                    <div class="input-group @error('pekerjaan') is-invalid @enderror">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i
                                                    class="bi bi-person-workspace"></i></span>
                                        </div>
                            ...
                            {{-- @foreach ($services as $service)
                                <div class="text-base"><a href="/kuesioner/{{ $service->id }}">{{ $service->id }}">
                                        {{ $service->service_text }}</a>
                                </div>
                            @endforeach --}}
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                                <button class="btn btn-primary" type="submit" value="submit">Lanjutkan</button>
                                {{-- <a href="/kuesioner/{id}" class="btn btn-primary">Lanjutkan</a> --}}

                                <!-- Button trigger modal -->
                                {{-- <button class="btn btn-primary" type="submit" value="submit" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">Lanjutkan</button> --}}
